...
namespace LorendisCore.Common.Damage
{
    ...
    public class DamageTypeMismatchException : Exception
    {
        ...
        /// <summary> An exception with a basic warning of types not being able to mistmatch. </summary>
        public DamageTypeMismatchException() : base(BASIC_MESSAGE)
        { }

        /// <summary> An exception that warns of types not being able to mismatch, specifying the types in the message. </summary>
