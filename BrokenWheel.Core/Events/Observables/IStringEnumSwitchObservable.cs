...
namespace BrokenWheel.Core.Events.Observables
{
    ...
    public interface IStringEnumSwitchObservable<out TEvent, in TEnum> : IEnumSwitchObservable<TEvent, TEnum>
        ...
        where TEnum : struct, IConvertible // enum
    {
        ...
        void SubscribeToCustomCategory(string customCategory, IEventHandler<TEvent> handler);
        ...
        void SubscribeToCustomCategory(string customCategory, EventHandlerFunction<TEvent> function);
        ...
        /// <param name="handler"> The event handler object. </param>
        void UnsubscribeFromCustomCategory(string customCategory, IEventHandler<TEvent> handler);
        ...
        /// <param name="customCategory"> The category of event. </param>
        /// <param name="function"> The event handler function. </param>
        void UnsubscribeFromCustomCategory(string customCategory, EventHandlerFunction<TEvent> function);
    }
}
